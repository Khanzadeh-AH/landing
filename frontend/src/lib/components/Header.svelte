...
<header class={`sticky top-0 z-40 border-b border-slate-200/70 dark:border-slate-800/70 backdrop-blur transition-colors ${scrolled ? 'bg-white/90 dark:bg-slate-950/70 shadow-sm' : 'bg-white/60 dark:bg-slate-950/40'}`}>
