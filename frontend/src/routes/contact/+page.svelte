...
<svelte:head>
  <title>تماس با ما | تهران‌بات</title>
  <meta name="description" content="برای مشاوره رایگان و شروع همکاری با تهران‌بات، از طریق فرم تماس یا روش‌های درج‌شده ارتباط بگیرید." />
</svelte:head>

<main id="main-content" class="section">
  <div class="container-rtl" use:reveal>
    <h1 class="text-3xl md:text-4xl">تماس با ما</h1>
  ...
  <section class="section pt-6">
    <div class="container-rtl grid gap-10 md:grid-cols-2 items-start">
      <div use:reveal>
        <ul class="mt-2 grid gap-3 text-sm text-slate-700 dark:text-slate-300">
